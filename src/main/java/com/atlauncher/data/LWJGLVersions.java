...
public class LWJGLVersions {
    ...
    public boolean usesLegacyLWJGL(MinecraftVersion minecraftVersion) {
        return legacyLwjglVersions.contains(minecraftVersion.id);
    }

    public boolean usesLegacyLWJGL(VersionManifestVersion manifestVersion) {
        return legacyLwjglVersions.contains(manifestVersion.id);
    }

    public LWJGLLibrary getLegacyLWJGLLibrary() {
        Optional<LWJGLMajorVersion> version = versions.stream().filter(v -> v.version == 2).findFirst();
    ...
    public Library getReplacementLWJGL3Library(MinecraftVersion minecraftVersion, Library library) {
        ...
        Optional<LWJGLMajorVersion> version = versions.stream().filter(v -> v.version == 3).findFirst();
     ...
     */
    public boolean shouldUseLegacyLWJGL(MinecraftVersion minecraftVersion) {
     ...
     */
    public boolean shouldReplaceLWJGL3(MinecraftVersion minecraftVersion) {
