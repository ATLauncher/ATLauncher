...
public class InstanceV1 implements Cloneable {
    private static final Logger LOG = LogManager.getLogger(InstanceV1.class);
    ...
    public void save(boolean showToast) {
        ...
        try {
            ...
            LOG.error("Failed to open instance.json for writing", e);
            return;
        }
        ...
        try {
            ...
            LOG.error("Failed to write instance.json", e);
        } finally {
            try {
                writer.close();
            } catch (IOException e) {
                LOG.error("Failed to close instance.json writer", e);
            }
        }
    }
