...
public interface ILoggingSettingsViewModel extends IAbstractSettingsViewModel  {
    ...
    void addOnLoggingLevelChanged(Consumer<String> onChanged);

    void setEnableLogging(Boolean b);
    void addOnEnableLoggingChanged(Consumer<Boolean> onChanged);

    void setEnableAnonAnalytics(Boolean b);
    void addOnEnableAnonAnalyticsChanged(Consumer<Boolean> onChanged);

    void setEnableOpenEyeReporting(Boolean b);
    void addOnEnableOpenEyeReportingChanged(Consumer<Boolean> onChanged);
}